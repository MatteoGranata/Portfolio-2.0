<template>
  <TemplateWorks
    ...
    :videoSrc="video"
    :details="details"
    description=" L'applicazione permette agli utenti di cercare libri per categoria, visualizzando i
  ...
  >
    ...
    >
      ...
      >
        <img :src="mockup" class="object-cover w-full h-[20rem] lg:h-full" />
      </div>
